...
var file_nft_transfer_v1_nft_transfer_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xd1, 0x03, 0x0a, 0x0b, 0x4e, 0x66, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	...
	0x2f, 0x73, 0x70, 0x61, 0x6d, 0x42, 0x3f, 0x0a, 0x13, 0x61, 0x70, 0x69, 0x2e, 0x6e, 0x66, 0x74,
...
var file_nft_transfer_v1_nft_transfer_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_nft_transfer_v1_nft_transfer_proto_goTypes = []interface{}{
	(*PostReportSpamRequest)(nil), // 0: api.nft_transfer.v1.PostReportSpamRequest
	(*PostReportSpamReply)(nil),   // 1: api.nft_transfer.v1.PostReportSpamReply
	(*SpamReport)(nil),            // 2: api.nft_transfer.v1.SpamReport
	(*GetReportSpamRequest)(nil),  // 3: api.nft_transfer.v1.GetReportSpamRequest
	(*GetReportSpamReply)(nil),    // 4: api.nft_transfer.v1.GetReportSpamReply
	(*GetNftTransferRequest)(nil), // 5: api.nft_transfer.v1.GetNftTransferRequest
	(*GetNftTransferReply)(nil),   // 6: api.nft_transfer.v1.GetNftTransferReply
	(*PnftTransferSt)(nil),        // 7: api.nft_transfer.v1.PnftTransferSt
	(*NodeStArr)(nil),             // 8: api.nft_transfer.v1.NodeStArr
	(*ActionStArr)(nil),           // 9: api.nft_transfer.v1.ActionStArr
	(*CostSt)(nil),                // 10: api.nft_transfer.v1.CostSt
}
var file_nft_transfer_v1_nft_transfer_proto_depIdxs = []int32{
	2,  // 0: api.nft_transfer.v1.PostReportSpamReply.data:type_name -> api.nft_transfer.v1.SpamReport
	2,  // 1: api.nft_transfer.v1.GetReportSpamReply.data:type_name -> api.nft_transfer.v1.SpamReport
	7,  // 2: api.nft_transfer.v1.GetNftTransferReply.data:type_name -> api.nft_transfer.v1.PnftTransferSt
	8,  // 3: api.nft_transfer.v1.PnftTransferSt.result:type_name -> api.nft_transfer.v1.NodeStArr
	9,  // 4: api.nft_transfer.v1.NodeStArr.actions:type_name -> api.nft_transfer.v1.ActionStArr
	10, // 5: api.nft_transfer.v1.ActionStArr.cost:type_name -> api.nft_transfer.v1.CostSt
	5,  // 6: api.nft_transfer.v1.NftTransfer.GetNftTransfer:input_type -> api.nft_transfer.v1.GetNftTransferRequest
	3,  // 7: api.nft_transfer.v1.NftTransfer.GetReportSpam:input_type -> api.nft_transfer.v1.GetReportSpamRequest
	0,  // 8: api.nft_transfer.v1.NftTransfer.PostReportSpam:input_type -> api.nft_transfer.v1.PostReportSpamRequest
	6,  // 9: api.nft_transfer.v1.NftTransfer.GetNftTransfer:output_type -> api.nft_transfer.v1.GetNftTransferReply
	4,  // 10: api.nft_transfer.v1.NftTransfer.GetReportSpam:output_type -> api.nft_transfer.v1.GetReportSpamReply
	1,  // 11: api.nft_transfer.v1.NftTransfer.PostReportSpam:output_type -> api.nft_transfer.v1.PostReportSpamReply
...
func file_nft_transfer_v1_nft_transfer_proto_init() {
	...
	file_nft_transfer_v1_nft_transfer_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
